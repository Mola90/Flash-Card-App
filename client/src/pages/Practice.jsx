            ...
            <div onClick={handleCardClick}>
              {showAnswer ? (
                ...
                <>
                  ...
                  <h2 className="text-xl md:mt-9 text-slate-100 hover:text-slate-300">{currentCard.question}</h2>
                </>
              )}
            </div>
            <div className="flex justify-center mt-9">
              <button
                className="text-5xl font-bold text-white bg-white rounded-xl px-4 py-1 shadow-lg"
                style={{ color: "#F6D864" }}
